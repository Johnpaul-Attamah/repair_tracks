...
export default function () {
    ...
    /*
      ...
      one uppercase letter and at least a number`);
            ...
            it('it should register an Engineer', (done) => {
                let user = {
                    username: 'engineUser',
                    name: 'Engineer',
            ...
            it('it should register a user as scape goat', (done) => {
                let user = {
                    username: 'scapegoat',
                    name: 'Scape Goat',
                    email: 'scapegoat@email.com',
                    password: 'scapeGOAT2020',
                    password2: 'scapeGOAT2020'
                }
                chai.request(server)
                    .post('/api/v1/auth/register')
                    .send(user)
            ...
            it('it should make an Admin actual Admin', (done) => {
